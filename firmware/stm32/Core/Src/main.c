...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOC, BAT_CTRL1_Pin|BAT_CTRL2_Pin|EPD_DC_Pin|EPD_RST_Pin
                          |RF_GPIO1_Pin|RF_GPIO2_Pin|RF_GPIO0_Pin|RF_RST_Pin
                          |PS1_Pin|PS2_Pin|PS3_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOA, EPD_CS_Pin|RF_CS_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, LED_Pin|PULL_CNTR_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(PS4_GPIO_Port, PS4_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : BAT_CTRL1_Pin BAT_CTRL2_Pin EPD_DC_Pin EPD_RST_Pin
                           RF_GPIO1_Pin RF_GPIO2_Pin RF_GPIO0_Pin RF_RST_Pin
                           PS1_Pin PS2_Pin PS3_Pin */
  GPIO_InitStruct.Pin = BAT_CTRL1_Pin|BAT_CTRL2_Pin|EPD_DC_Pin|EPD_RST_Pin
                          |RF_GPIO1_Pin|RF_GPIO2_Pin|RF_GPIO0_Pin|RF_RST_Pin
                          |PS1_Pin|PS2_Pin|PS3_Pin;
  ...
  /*Configure GPIO pins : EPD_CS_Pin RF_CS_Pin */
  GPIO_InitStruct.Pin = EPD_CS_Pin|RF_CS_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(GPIOA, &GPIO_InitStruct);
  ...
  /*Configure GPIO pins : LED_Pin PULL_CNTR_Pin */
  GPIO_InitStruct.Pin = LED_Pin|PULL_CNTR_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(GPIOB, &GPIO_InitStruct);
  ...
  /*Configure GPIO pin : PS4_Pin */
  GPIO_InitStruct.Pin = PS4_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(PS4_GPIO_Port, &GPIO_InitStruct);
