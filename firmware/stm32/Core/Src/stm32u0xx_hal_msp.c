...
void HAL_ADC_MspInit(ADC_HandleTypeDef* hadc)
{
  ...
  */
    ...
    PC1     ------> ADC1_IN1
    */
    GPIO_InitStruct.Pin = AN1_Pin|AN2_Pin;
...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  if(hadc->Instance==ADC1)
  {
    ...
    PC1     ------> ADC1_IN1
    */
    HAL_GPIO_DeInit(GPIOC, AN1_Pin|AN2_Pin);
...
void HAL_SPI_MspDeInit(SPI_HandleTypeDef* hspi)
{
  if(hspi->Instance==SPI1)
  {
    ...
    PA7     ------> SPI1_MOSI
    */
    HAL_GPIO_DeInit(GPIOA, EPD_SCK_Pin|EPD_DIN_Pin);
...
void HAL_UART_MspInit(UART_HandleTypeDef* huart)
{
  ...
  */
    ...
    PA1     ------> USART4_RX
    */
    GPIO_InitStruct.Pin = DBG_TX_Pin|DGB_RX_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
...
void HAL_UART_MspDeInit(UART_HandleTypeDef* huart)
{
  ...
  else if(huart->Instance==USART4)
  {
    ...
    PA1     ------> USART4_RX
    */
    HAL_GPIO_DeInit(GPIOA, DBG_TX_Pin|DGB_RX_Pin);
